...
@Component({
            ...
            <div class="student-status-board pending-board">
              ...
              <div class="board-content">
                ...
                <div class="guarantee-box">
                  🛡️ <strong>No payment is required today.</strong> Payment instructions & receipt upload will be unlocked right here on your dashboard <strong>as soon as admin approves teacher availability</strong> within 3-5 working hours.
                </div>
              </div>
            </div>
          }
  ...
  styles: [`
    ...
    .student-status-board { background: var(--color-surface); border-radius: 14px; padding: 1.75rem; border: 2px solid var(--color-border); box-shadow: var(--shadow-card); margin-bottom: 1.5rem; }
    ...
    .student-status-board.approved-board { border-color: #10b981; background: linear-gradient(135deg, rgba(16, 185, 129, 0.06), rgba(5, 150, 105, 0.02)); }
    ...
    .badge-approved { display: inline-block; background: #10b981; color: white; padding: 0.25rem 0.75rem; border-radius: 15px; font-weight: 700; font-size: 0.8rem; }
    ...
    .guarantee-box { background: rgba(16, 185, 129, 0.1); border: 1px solid #10b981; padding: 0.85rem 1rem; border-radius: 10px; margin-top: 1rem; font-size: 0.9rem; color: #047857; line-height: 1.5; }

    .assigned-tutor-highlight { background: rgba(16, 185, 129, 0.12); border: 1.5px solid #10b981; padding: 0.85rem 1.25rem; border-radius: 10px; font-size: 1rem; color: #047857; margin-bottom: 1.25rem; }
    .tutor-name { font-weight: 800; font-size: 1.1rem; color: #065f46; }

    .payment-dashboard-box { background: var(--color-bg); border: 1px solid var(--color-border); border-radius: 12px; padding: 1.25rem; margin-top: 1rem; }
    ...
    .account-no code { background: rgba(59, 130, 246, 0.15); color: #2563eb; padding: 0.2rem 0.5rem; border-radius: 4px; font-weight: 800; font-size: 0.95rem; }
    ...
    .btn-submit-receipt { background: #10b981; color: white; border: none; padding: 0.75rem 1.5rem; border-radius: 8px; font-weight: 700; font-size: 0.95rem; cursor: pointer; width: 100%; margin-top: 1rem; }
    ...
    .review-note { color: #059669; font-weight: 600; margin: 0; }
    ...
    .assigned-teacher-card-full { display: flex; align-items: center; gap: 1.25rem; background: linear-gradient(135deg, rgba(11, 61, 46, 0.08), rgba(5, 150, 105, 0.04)); border: 1.5px solid var(--color-accent); border-radius: 14px; padding: 1.25rem 1.5rem; margin-bottom: 1.5rem; }
    .teacher-avatar-icon { font-size: 3rem; }
    .badge-active-tutor { font-size: 0.75rem; font-weight: 700; background: #10b981; color: white; padding: 0.15rem 0.6rem; border-radius: 12px; display: inline-block; margin-bottom: 0.35rem; }
    ...
    .schedule-summary-card { display: flex; align-items: center; gap: 1.25rem; background: var(--color-surface); border: 1px solid var(--color-border); padding: 1.25rem; border-radius: 12px; margin-bottom: 1.5rem; }
    ...
    .btn-view-schedule { background: var(--color-accent); color: white; padding: 0.6rem 1.1rem; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 0.88rem; white-space: nowrap; }

    .yearly-plan-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1rem; margin-bottom: 1.5rem; }
    .plan-card { background: var(--color-surface); border: 1px solid var(--color-border); border-radius: 12px; padding: 1rem; position: relative; }
    ...
    .action-card.add-course-card { border-color: #059669; background: rgba(16, 185, 129, 0.08); cursor: pointer; text-align: left; }
    ...
    /* Modal Form Styles */
    .modal-card-box { background: var(--color-surface); color: var(--color-text); border: 1px solid var(--color-border); border-radius: 14px; width: 100%; max-width: 520px; padding: 1.75rem; box-shadow: var(--shadow-card-hover); }
    ...
    .btn-save { background: var(--color-accent); color: white; border: none; padding: 0.65rem 1.35rem; border-radius: 6px; font-weight: 600; cursor: pointer; }
