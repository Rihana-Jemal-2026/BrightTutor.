...
@Component({
  ...
  styles: [`
    ...
    .filter-pills button.active { background: var(--color-action); color: #fff; border-color: var(--color-accent); }
    
    .registrations-list { display: flex; flex-direction: column; gap: 1.25rem; }
    .registration-card { background: var(--color-surface); border: 1px solid var(--color-border); border-radius: var(--radius-lg); padding: 1.25rem; box-shadow: var(--shadow-card); }
    ...
    .assigned-teacher-banner { background: rgba(var(--color-accent-rgb), 0.1); border: 1px solid rgba(var(--color-accent-rgb), 0.3); color: #047857; padding: 0.5rem 0.75rem; border-radius: 6px; font-size: 0.88rem; margin-bottom: 0.75rem; }
    ...
    .btn-assign { background: var(--color-action); color: #fff; border: none; padding: 0.55rem 1.1rem; border-radius: 6px; font-weight: 600; cursor: pointer; }
    .btn-verify { background: var(--color-action); color: #fff; border: none; padding: 0.55rem 1.1rem; border-radius: 6px; font-weight: 600; cursor: pointer; }
    ...
    .btn-primary { background: var(--color-action); color: #fff; border: none; padding: 0.55rem 1.1rem; border-radius: 6px; font-weight: 600; cursor: pointer; }
    ...
    .verified-badge { color: var(--color-accent); font-weight: 600; font-size: 0.9rem; }
    .awaiting-payment-info { background: rgba(59, 130, 246, 0.1); border: 1px solid rgba(59, 130, 246, 0.3); color: var(--color-info); padding: 0.5rem 0.85rem; border-radius: 6px; font-size: 0.88rem; flex: 1; }
    ...
    .status-verified { background: rgba(var(--color-accent-rgb), 0.15); color: var(--color-accent); }
